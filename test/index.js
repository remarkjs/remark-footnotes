...
test('html', (t) => {
  ...
  t.equal(
    p
      ...
      .toString(),
    [
      '<p>Here is an inline note.<sup><a href="#user-content-fn-1" id="user-content-fnref-1" data-footnote-ref aria-describedby="footnote-label">1</a></sup></p>',
      '<section data-footnotes class="footnotes"><h2 id="footnote-label" class="sr-only">Footnotes</h2>',
      '<ol>',
      '<li id="user-content-fn-1">',
      '<p>Inlines notes are easier to write, since',
      'you don’t have to pick an identifier and move down to type the',
      'note. <a href="#user-content-fnref-1" data-footnote-backref class="data-footnote-backref" aria-label="Back to content">↩</a></p>',
      '</li>',
      '</ol>',
      '</section>'
    ].join('\n'),
